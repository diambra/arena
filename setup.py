...
setuptools.setup(
    ...
    download_url='https://github.com/diambra/arena',
    version='2.0a0',
    author="DIAMBRA Team",
    author_email="info@diambra.ai",
    description="DIAMBRA™ Arena. Built with OpenAI Gym, easy to use, transforms popular video games into Reinforcement Learning environments.",
