...
class diambraArenaLib:
    ...
    def envKwargsToString(self, envSettings):
        ...
        # MVSC Specific
        output += "fightingMode1"+"+1+"+str(envSettings["fightingMode"][0]) + "+"
        output += "fightingMode2"+"+1+"+str(envSettings["fightingMode"][1]) + "+"
        output += "speedMode1"+"+1+"+str(envSettings["speedMode"][0]) + "+"
        output += "speedMode2"+"+1+"+str(envSettings["speedMode"][1]) + "+"
